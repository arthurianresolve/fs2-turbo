...
pub(crate) mod test_support {
    ...
    pub(crate) use super::space::{
        ...
        handle_space_query_result, handle_space_with, is_volume_resolution_error, root_space_with,
        space, space_after_exact_root, statvfs_root_with, with_owned_handle,
    };
}
